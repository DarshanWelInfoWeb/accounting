...
class AddPayment extends StatefulWidget {
  int customerId,type;
  AddPayment(this.customerId,this.type,{Key? key}) : super(key: key);
...
class _AddPaymentState extends State<AddPayment> {
  ...
  void initState() {
    ...
    super.initState();
    print("id::::${widget.customerId}:::${widget.type}");
  ...
  _addPayment(){
    if (dropdownValue == null) {
      ...
      AppConstants.getToast("Please Enter Cash");
        ...
        Add_Main_Payment_Body payment = Add_Main_Payment_Body(
          intType: 1,
        ...
        Provider.of<MainPaymentProvider>(context, listen: false).getAddMainPayment(context,payment,_route);
