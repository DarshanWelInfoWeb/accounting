                    ...
                    children: [
                      ...
                      Column(
                        children: [
                          ...
                          // Container(
                          //   decoration: BoxDecoration(
                          //     color: _isExpands?ColorResources.WHITE:ColorResources.transparant,
                          //     borderRadius: BorderRadius.circular(10),
                          //     border: Border.all(color: _isExpands?Colors.black12:ColorResources.transparant),
                          //   ),
                          //   child: Column(
                          //     children: [
                          //       SizedBox(
                          ...
                          //               _isExpands ? _controller.forward() : _controller.reverse();
                          //               print("objectd:::$_isExpands ::$_isExpa");
                          //               setState(() {
                          //                 _isExpands = !_isExpands;
                          //                 // _currentHeight = isExpanded ? 0 : _expandedHeight;
                          //               });
                          //             },
                          //             leading: const Image(image: AssetImage(Images.shop),color: ColorResources.GREY,height: 25,width: 25),
                          //             trailing: _isExpands?const Icon(Icons.keyboard_arrow_up,color: ColorResources.GREY,size: 25):const Icon(Icons.keyboard_arrow_down,color: ColorResources.GREY,size: 25),
                          //             title: Text("Sale",style: montserratSemiBold.copyWith(fontSize: 15))),
                          //       ),
                          //       _isExpands?
                          //       AnimatedContainer(
                          ...
                          // Container(
                          //   decoration: BoxDecoration(
                          //     color: _isExpa?ColorResources.WHITE:ColorResources.transparant,
                          //     borderRadius: BorderRadius.circular(10),
                          //     border: Border.all(color: _isExpa?Colors.black12:ColorResources.transparant),
                          //   ),
                          //   child: Column(
                          //     children: [
                          //       SizedBox(
                          ...
                          //               var isExpanded = _currentHeight == _expandedHeight;
                          //               _isExpa = !_isExpa;
                          //               _isExpa ? _controller.forward() : _controller.reverse();
                          //               print("object:::$_isExpands ::$_isExpa");
                          //               setState(() {
                          //                 _currentHeight = isExpanded ? 0 : _expandedHeight;
                          //               });
                          //             },
                          //             leading: const Image(image: AssetImage(Images.purchasing),color: ColorResources.GREY,height: 25,width: 25),
                          //             trailing: _isExpa?const Icon(Icons.keyboard_arrow_up,color: ColorResources.GREY,size: 25):const Icon(Icons.keyboard_arrow_down,color: ColorResources.GREY,size: 25),
                          //             title: Text("Purchase",style: montserratSemiBold.copyWith(fontSize: 15))),
                          //       ),
                          //       _isExpa?
                          //       AnimatedContainer(
                          //         height: _currentHeight,
                          ...
                          // Container(
                          //   decoration: BoxDecoration(
                          //     color: _isExpandReport?ColorResources.WHITE:ColorResources.transparant,
                          //     borderRadius: BorderRadius.circular(10),
                          //     border: Border.all(color: _isExpandReport?Colors.black12:ColorResources.transparant),
                          //   ),
                          //   child: Column(
                          //     children: [
                          //       SizedBox(
                          ...
                          //             onTap: () {
                          //               var isExpanded = _currentHeight == _expandedHeight;
                          //               _isExpandReport = !_isExpandReport;
                          //               _isExpandReport ? _controller.forward() : _controller.reverse();
                          //               setState(() {
                          //                 _currentHeight = isExpanded ? 0 : _expandedHeight;
                          //               });
                          //             },
                          //             leading: const Icon(Icons.report_gmailerrorred,color: ColorResources.GREY,size: 25),
                          //             trailing: _isExpandReport?const Icon(Icons.keyboard_arrow_up,color: ColorResources.GREY,size: 25):const Icon(Icons.keyboard_arrow_down,color: ColorResources.GREY,size: 25),
                          //             title: Text("Report",style: montserratSemiBold.copyWith(fontSize: 15))),
                          //       ),
                          //       _isExpandReport?
                          //       AnimatedContainer(
                          //         height: _currentHeight,
                          ...
                          // Container(
                          //   decoration: BoxDecoration(
                          //     color: _isExpand?ColorResources.WHITE:ColorResources.transparant,
                          //     borderRadius: BorderRadius.circular(10),
                          //     border: Border.all(color: _isExpand?Colors.black12:ColorResources.transparant),
                          //   ),
                          //   child: Column(
                          //     children: [
                          //       SizedBox(
                          ...
                          //                 _currentHeight = isExpanded ? 0 : _expandedHeight;
                          //               });
                          //               print("object::::$_isExpand");
                          //             },
                          //             leading: const Image(image: AssetImage(Images.setup),color: ColorResources.GREY,height: 25,width: 25),
                          //             trailing: _isExpand?const Icon(Icons.keyboard_arrow_up,color: ColorResources.GREY,size: 25):const Icon(Icons.keyboard_arrow_down,color: ColorResources.GREY,size: 25),
                          //             title: Text("Setup",style: montserratSemiBold.copyWith(fontSize: 15))),
                          //       ),
                          //       _isExpand?
                          //       AnimatedContainer(
                          //         height: _currentHeight,
                          ...
                          // Container(
                          //   decoration: BoxDecoration(
                          //     color: _isExpandSetting?ColorResources.WHITE:ColorResources.transparant,
                          //     borderRadius: BorderRadius.circular(10),
                          //     border: Border.all(color: _isExpandSetting?Colors.black12:ColorResources.transparant),
                          //   ),
                          //   child: Column(
                          //     children: [
                          //       SizedBox(
                          ...
                          //             onTap: () {
                          //               var isExpanded = _currentHeight == _expandedHeight;
                          //               _isExpandSetting = !_isExpandSetting;
                          //               _isExpandSetting ? _controller.forward() : _controller.reverse();
                          //               setState(() {
                          //                 _currentHeight = isExpanded ? 0 : _expandedHeight;
                          //               });
                          //             },
                          //             leading: const Icon(Icons.settings,color: ColorResources.GREY,size: 25),
                          //             trailing: _isExpandSetting?const Icon(Icons.keyboard_arrow_up,color: ColorResources.GREY,size: 25):const Icon(Icons.keyboard_arrow_down,color: ColorResources.GREY,size: 25),
                          //             title: Text("Setting",style: montserratSemiBold.copyWith(fontSize: 15))),
                          //       ),
                          //       _isExpandSetting?
                          //       AnimatedContainer(
                          //         height: _currentHeight,
                          ...
                          // ExpansionTile(
                          //   title: Text("Sale",style: montserratSemiBold.copyWith(fontSize: 15)),
                          //   leading: const Image(image: AssetImage(Images.shop),color: ColorResources.GREY,height: 25,width: 25), //add icon
                          //   backgroundColor: ColorResources.WHITE,
                          ...
                          // ExpansionTile(
                          //   title: Text("Purchase",style: montserratSemiBold.copyWith(fontSize: 15)),
                          //   leading: const Image(image: AssetImage(Images.purchasing),color: ColorResources.GREY,height: 25,width: 25), //add icon
                          //   backgroundColor: ColorResources.WHITE,
                          //   textColor: ColorResources.BLACK,
                          //   iconColor: ColorResources.BLACK,
                          //   children: [
                          ...
                          //       child: ListTile(
                          //           onTap:() {
                          //             Navigator.of(context).push(MaterialPageRoute(builder: (context) => SupplierList(),));
                          //           },
                          //           leading: const Image(image: AssetImage(Images.party),color: ColorResources.GREY,height: 25,width: 25),
                          //           title: Text("Manage Party",style: montserratSemiBold.copyWith(fontSize: 15))),
                          //     ),
                          ...
                          // ExpansionTile(
                          //   title: Text("Setup",style: montserratSemiBold.copyWith(fontSize: 15)),
                          //   leading: const Image(image: AssetImage(Images.setup),color: ColorResources.GREY,height: 25,width: 25), //add icon
                          //   backgroundColor: ColorResources.WHITE,
                          //   textColor: ColorResources.BLACK,
                          //   iconColor: ColorResources.BLACK,
                          //   children: [
                          ...
                          //           },
                          //           leading: const Image(image: AssetImage(Images.unit),color: ColorResources.GREY,height: 25,width: 25),
                          //           title: Text("Unit",style: montserratSemiBold.copyWith(fontSize: 15))),
                          //     ),
                          //     SizedBox(
                          //       height: AppConstants.itemHeight*0.06,
                          //       child: ListTile(
                          ...
                          // ),
                          // ExpansionTile(
                          //   title: Text("Expense Report",style: montserratSemiBold.copyWith(fontSize: 15)),
                          //   leading: const Icon(Icons.report_gmailerrorred,color: ColorResources.GREY,size: 25), //add icon
                          //   backgroundColor: ColorResources.WHITE,
                          //   textColor: ColorResources.BLACK,
                          //   iconColor: ColorResources.BLACK,
                          //   children: [
                      ...
                      Column(
                        children: [
                          ...
                          //             leading: const Icon(Icons.report_gmailerrorred,color: ColorResources.GREY,size: 25),
                          //             trailing: _isExpanded?const Icon(Icons.keyboard_arrow_up,color: ColorResources.GREY,size: 25):const Icon(Icons.keyboard_arrow_down,color: ColorResources.GREY,size: 25),
                          //             title: Text("Report",style: montserratSemiBold.copyWith(fontSize: 15))),
                          //       ),
                          //       _isExpanded?
                          //       AnimatedContainer(
                          ...
                          //         Navigator.of(context).push(MaterialPageRoute(builder: (context) => CustomerList(),));
                          //       },
                          //       leading: const Image(image: AssetImage(Images.team),color: ColorResources.GREY,height: 25,width: 25),
                          //       title: Text("Manage Customer",style: montserratSemiBold.copyWith(fontSize: 15))),
                          // ),
                          // SizedBox(
                          //   height: AppConstants.itemHeight * 0.06,
                          //   child: ListTile(
                          ...
                          //       },
                          //       leading: const Image(image: AssetImage(Images.bookkeeping),color: ColorResources.GREY,height: 25,width: 25),
                          //       title: Text("Manage Invoice",style: montserratSemiBold.copyWith(fontSize: 15))),
                          // ),
                          // SizedBox(
                          //   height: AppConstants.itemHeight * 0.06,
                          //   child: ListTile(
                          ...
                          //       },
                          //       leading: const Image(image: AssetImage(Images.bill),color: ColorResources.GREY,height: 25,width: 25),
                          //       title: Text("Manage Payment",style: montserratSemiBold.copyWith(fontSize: 15))),
                          // ),
                          // SizedBox(
                          //   height: AppConstants.itemHeight * 0.06,
                          //   child: ListTile(
                          ...
                          //       },
                          //       leading: const Image(image: AssetImage(Images.priceList),color: ColorResources.GREY,height: 25,width: 25),
                          //       title: Text("Manage Item Price",style: montserratSemiBold.copyWith(fontSize: 15))),
                          // ),
                          // SizedBox(
                          //   height: AppConstants.itemHeight * 0.06,
                          //   child: ListTile(
                          ...
                          //       },
                          //       leading: const Image(image: AssetImage(Images.supplier),color: ColorResources.GREY,height: 25,width: 25),
                          //       title: Text("Manage Supplier",style: montserratSemiBold.copyWith(fontSize: 15))),
                          // ),
                          // SizedBox(
                          //   height: AppConstants.itemHeight * 0.06,
                          //   child: ListTile(
                          ...
                          //         Navigator.of(context).push(MaterialPageRoute(builder: (context) => SupplierInvoiceList("","","","SupplierInvoice"),));
                          //       },
                          //       leading: const Image(image: AssetImage(Images.supplierInvoice),color: ColorResources.GREY,height: 25,width: 25),
                          //       title: Text("Manage Supplier Invoice",style: montserratSemiBold.copyWith(fontSize: 15))),
                          // ),
                          // SizedBox(
                          //   height: AppConstants.itemHeight * 0.06,
                          //   child: ListTile(
                          ...
                          //         Navigator.of(context).push(MaterialPageRoute(builder: (context) => SupplierPaymentList("","Side"),));
                          //       },
                          //       leading: const Image(image: AssetImage(Images.supplierPayment),color: ColorResources.GREY,height: 25,width: 25),
                          //       title: Text("Manage Supplier Payment",style: montserratSemiBold.copyWith(fontSize: 15))),
                          // ),
                        ],
                      ),
                     /* PreferenceUtils.getlogin(AppConstants.includeGst) != true?
                        ...
                        children: [
                          ...
                          SizedBox(
                            ...
                            child: ListTile(
                                ...
                                leading: const Image(image: AssetImage(Images.bill),color: ColorResources.GREY,height: 25,width: 25),
                                title: Text("Payment",style: montserratSemiBold.copyWith(fontSize: 15))),
                          ),
                          SizedBox(
                            height: AppConstants.itemHeight * 0.06,
                            child: ListTile(
