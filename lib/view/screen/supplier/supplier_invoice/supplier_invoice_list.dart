...
import 'package:gas_accounting/view/screen/supplier/supplier_invoice/add_supplier_invoice.dart';
import 'package:gas_accounting/view/screen/supplier/supplier_invoice/edit_supplier_invoice.dart';
import 'package:gas_accounting/view/screen/supplier/supplier_invoice/pdfexportsupplier/pdfpreview.dart';
import 'package:intl/intl.dart';
import 'package:month_picker_dialog/month_picker_dialog.dart';
import 'package:provider/provider.dart';

class SupplierInvoiceList extends StatefulWidget {
  String startDate,endDate,supplierId,type;
  SupplierInvoiceList(this.startDate,this.endDate,this.supplierId,this.type,{super.key});

  @override
  State<SupplierInvoiceList> createState() => _SupplierInvoiceListState();
}
...
class _SupplierInvoiceListState extends State<SupplierInvoiceList> {
  ...
  void initState() {
    ...
    print("supplier ::${widget.supplierId}");
  }

  Future<void> _loadData(BuildContext context, bool reload) async {
    Future.delayed(Duration.zero, () async {
      Provider.of<SupplierProvider>(context, listen: false).getSupplierInvoiceList(
          context,
          PreferenceUtils.getString("${AppConstants.companyId}"),
          widget.type != "SupplierInvoice" ? widget.startDate: start_date,
          widget.type != "SupplierInvoice" ? widget.endDate: end_date,
  ...
  Widget build(BuildContext context) {
    return Consumer(builder: (context, value, child) {
      return WillPopScope(
        onWillPop: () async{
          Navigator.push(context,MaterialPageRoute(builder: (context) => Dashboard(widget.type != "SupplierInvoice" ?"":"Home")));
          return true;
          },
        child: Consumer<SupplierProvider>(builder: (context, supplier, child) {
          return Scaffold(
            appBar: AppBar(
              ...
              title: Text("Supplier Invoice",style: montserratSemiBold.copyWith(color: ColorResources.WHITE,fontSize: Dimensions.FONT_SIZE_20),),
            ),
            floatingActionButton: FloatingActionButton(
              onPressed: () {
                Navigator.push(context, MaterialPageRoute(builder: (context) => AddSupplierInvoice(0,"","","",false,"New")));
              },
            ...
            Container(
              ...
              Column(
                ...
                children: [
                        ...
                        onTap: () {
                          showMonthPicker(
                            ...
                            setState(() {
                              ...
                              Provider.of<SupplierProvider>(context, listen: false).getSupplierInvoiceList(context,PreferenceUtils.getString("${AppConstants.companyId}"),start_date,end_date,supplierDropDown.toString()).then((value) {
                                setState(() {
                                  isLoading = false;
                                });
                              });
                                ...
                                child: TypeAheadFormField<SupplierData>(
                                  textFieldConfiguration: TextFieldConfiguration(
                                    ...
                                    decoration: InputDecoration(
                                      hintText: widget.type!="SupplierInvoice"?supplierName:'Select Supplier',
                  ...
                  Flexible(
                    child:
                    supplier.supplierInvoiceList.isNotEmpty
                        ?
                    ListView.builder(
                      scrollDirection: Axis.vertical,
                      physics: const BouncingScrollPhysics(),
                      shrinkWrap: true,
                      itemCount: supplier.supplierInvoiceList.length,
                            ...
                            child: Row(
                              children: [
                                Container(
                                  ...
                                  child: Text(
                                    supplier.supplierInvoiceList[index].strSuppliername!.substring(0,1).toUpperCase(),
                                ...
                                Container(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      supplier.supplierInvoiceList[index].strInvoiceno == null ? const SizedBox():
                                      Text("# ${supplier.supplierInvoiceList[index].strInvoiceno}",style: poppinsSemiBold.copyWith(color: ColorResources.BLACK,fontSize: Dimensions.FONT_SIZE_14),),
                                      Row(
                                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                        children: [
                                          Container(
                                              ...
                                              child: Row(
                                                ...
                                                children: [
                                                  ...
                                                  Container(
                                                    ...
                                                    child: Text(
                                                      supplier.supplierInvoiceList[index].strSuppliername.toString(),
                                                      maxLines: 1,
                                          ...
                                          Text("\u20b9 ${supplier.supplierInvoiceList[index].decTotal}",style: poppinsBold.copyWith(color: ColorResources.BLACK,fontSize: Dimensions.FONT_SIZE_15),),
                                        ],
                                      ),
                                      Row(
                                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                        children: [
                                          Text(AppConstants.date_chang(supplier.supplierInvoiceList[index].strinvoicedate.toString()),style: poppinsSemiBold.copyWith(color: ColorResources.GREY,fontSize: Dimensions.FONT_SIZE_14),),
                                          InkWell(
                                            onTap: () {
                                              Navigator.push(context, MaterialPageRoute(builder: (context) => PdfPreviewPageSupplierInvoice(
                                                  "Invoice",
                                                  supplier.supplierInvoiceList[index].intid.toString(),
                                                  supplier.supplierInvoiceList[index].strSuppliername.toString(),
                                                  "","")));
                                            },
                                            child: Container(
                                ...
                                PopupMenuButton(
                                  ...
                                  onSelected: (result) {
                                    if (result == 0) {
                                      Navigator.push(context, MaterialPageRoute(builder: (context) => EditSupplierInvoice(supplier.supplierInvoiceList[index].intid!,supplierDropDown.toString(),supplier.supplierInvoiceList[index].strSuppliername.toString(),"","","",false,"Edit")));
                                    }else{
                                      showDialog<bool>(
                                          ...
                                          builder: (BuildContext context) {
                                            return AlertDialog(
                                              ...
                                              actions: [
                                                TextButton(
                                                  onPressed: () {
                                                    Provider.of<SupplierProvider>(context, listen: false).getDeleteSupplierInvoice(context,"${supplier.supplierInvoiceList[index].intid}").then((value) {
                                                      AppConstants.getToast("Deleted Successfully");
                                                      Navigator.push(context, MaterialPageRoute(builder: (context) => SupplierInvoiceList("","",supplierDropDown.toString(),"SupplierInvoice")));
                                                    });
                                                  },
  ...
  String _getValueText(
    ...
    if (datePickerType == CalendarDatePicker2Type.multi) {
      ...
      if (values.isNotEmpty) {
        ...
        Provider.of<SupplierProvider>(context, listen: false).getSupplierInvoiceList(context,PreferenceUtils.getString(AppConstants.companyId.toString()),_startDate,_enddate,supplierDropDown.toString()).then((value) {
          setState(() {
            isLoading = false;
          });
        });
